...
public class BookRepository implements BookRepositoryInterface {
    ...
    private  ConcurrentHashMap<Long, Book> bookInMemoryMap;
    ...
    /**
     * This will save newly shipped book with ISBN for new books.
     */
	...
	System.out.println("Successfully added new book:" + newBook + " into the libary");
